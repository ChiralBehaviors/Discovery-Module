...
@JsonSubTypes({
               @Type(value = HiveScopeConfiguration.class, name = "hiveScope"),
               @Type(value = GossipScopeConfiguration.class, name = "gossipScope"),
               @Type(value = LocalScopeConfiguration.class, name = "localScope") })
public class DiscoveryMixin {
